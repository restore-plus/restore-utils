...
#' @export
load_terraclass_cerrado_2020 <- function(version = "v1", multicores = 32, memsize = 120) {
    terraclass_dir <- .terraclass_dir(version, 2020)
    terraclass_rds <- .terraclass_rds(terraclass_dir)
...
#' @export
load_terraclass_cerrado_2022 <- function(version = "v1", multicores = 32, memsize = 120) {
    terraclass_dir <- .terraclass_dir(version, 2022)
    terraclass_rds <- .terraclass_rds(terraclass_dir)
...
#' @export
load_terraclass_cerrado_2024 <- function(version = "v1", multicores = 32, memsize = 120) {
    terraclass_dir <- .terraclass_dir(version, 2024)
    terraclass_rds <- .terraclass_rds(terraclass_dir)
