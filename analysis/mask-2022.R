...
output_dir_base <- "data/derived/masks/mask-mcti-v4-new"
...
# Terraclass
#
terraclass <- load_terraclass_2022()
        ...
        "Pasture_Wetland" = (
            cube %in% c("Seasonally_Flooded_ICS", "Wetland_ICS") &
                mask %in% c("d2000", "d2001", "d2002","d2003","d2004", "d2005", "d2006",
                            ...
                            "d2014", "d2015", "d2016", "d2017", "d2018", "d2019", "d2020",
                            "d2021",
                            "r2010", "r2011", "r2012", "r2013", "r2014", "r2015",
                            "r2016", "r2017", "r2018", "r2019", "r2020", "r2021", "r2022")
        )
    ),
    multicores = multicores,
    memsize = memsize,
