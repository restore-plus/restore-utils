...
# Classification
#
eco3_class_2020 <- load_restore_map(data_dir = output_dir,
...
# Step 1
#
eco3_mask_2020 <- sits_clean(
    cube = eco3_class_2020,
    window_size = 5,
    multicores = multicores,
    memsize = memsize,
...
# Step 2
#
eco3_mask_2020 <- sits_reclassify(
    cube = eco3_mask_2020,
    mask = prodes,
    rules = list(
        ...
        "Pasture_Wetland" = (
            cube %in% c("Seasonally_Flooded_ICS", "Wetland_ICS") &
                mask %in% c("d2000", "d2001", "d2002","d2003","d2004", "d2005", "d2006",
                            ...
                            "d2014", "d2015", "d2016", "d2017", "d2018", "d2019",
...
# Generate COG data
#
sf::gdal_addo(eco3_mask_2020[["file_info"]][[1]][["path"]])

saveRDS(eco3_mask_2020, output_dir / "mask-cube.rds")
